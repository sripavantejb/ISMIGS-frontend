...
export function ProfitProjection({
  ...
  return (
    <Card className="rounded-xl border-emerald-900/40 bg-card">
      <CardHeader>
        <CardTitle className="text-lg text-emerald-400">{cropName} — Projection</CardTitle>
      </CardHeader>
      <CardContent className="space-y-2">
        ...
        <p className="text-base font-semibold text-foreground">Net profit: <span className={netProfit >= 0 ? "text-emerald-400" : "text-destructive"}>₹ {netProfit.toLocaleString("en-IN")}</span></p>
