  ...
  return (
    <section id="disclosure-flow" className="relative z-10">
      ...
      <div ref={sectionRef} className="relative" style={{ height: '500vh' }}>
        ...
        <div className="sticky top-0 w-full min-h-screen flex flex-col justify-center bg-ismigs-dark">
          <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="flex-1 max-w-2xl">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <p className="text-ismigs-purple font-semibold text-sm uppercase tracking-wider">
            ...
            <div className="flex-shrink-0 flex items-center justify-center lg:justify-end">
              <motion.span
                ...
                className="text-ismigs-purple font-bold text-[8rem] md:text-[10rem] lg:text-[12rem] leading-none select-none"
              >
                {stepNumber}
              </motion.span>
            </div>
