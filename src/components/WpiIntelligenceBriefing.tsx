...
interface WpiIntelligenceBriefingProps {
  sectorName: string;
  context: SectorData;
}
...
export function WpiIntelligenceBriefing({ sectorName, context }: WpiIntelligenceBriefingProps) {
  ...
  useEffect(() => {
    ...
    const key = `wpi:${sectorName}:${contextKey}`;
  ...
  if (error) {
    return (
      <div className={`${CARD_CLASS} p-5`}>
        <h2 className="text-lg font-semibold text-foreground mb-2">Inflation intelligence</h2>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <h2 className="text-xl font-bold text-foreground">Inflation intelligence</h2>
            ...
            <div className="flex gap-3 p-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-muted-foreground mb-3">
                  In plain language — how this inflation category can affect your daily life and what to watch for.
                </p>
                {mainSection ? (
