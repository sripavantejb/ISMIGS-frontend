...
interface IipIntelligenceBriefingProps {
  sectorName: string;
  context: SectorData;
}
...
export function IipIntelligenceBriefing({ sectorName, context }: IipIntelligenceBriefingProps) {
  ...
  useEffect(() => {
    ...
    const key = `iip:${sectorName}:${contextKey}`;
  ...
  if (error) {
    return (
      <div className={`${CARD_CLASS} p-5`}>
        <h2 className="text-lg font-semibold text-foreground mb-2">IIP intelligence</h2>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <h2 className="text-xl font-bold text-foreground">IIP intelligence</h2>
            ...
            <div className="flex gap-3 p-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-muted-foreground mb-3">
                  In plain language — how industrial production trends in this sector can affect jobs, prices, and growth.
                </p>
                {mainSection ? (
