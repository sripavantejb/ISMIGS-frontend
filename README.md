# ISMIGS — India State Macro Intelligence & GIS System

Economic and energy analytics dashboard powered by real MoSPI APIs. No mock data.
...
- **CPI CSV** — State-level CPI-AL/RL from `public/data/cpialrl_11.csv`
